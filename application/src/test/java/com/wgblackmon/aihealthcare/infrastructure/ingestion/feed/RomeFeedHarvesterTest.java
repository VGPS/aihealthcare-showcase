...
class RomeFeedHarvesterTest {
    ...
    void feedHarvestScheduler_constructionWithBothPorts_doesNotThrow() {
        FeedHarvestScheduler scheduler = new FeedHarvestScheduler(harvester, mockArticleStoragePort, mockTopicSummaryService, mockNewsTopicProperties, null, null, null, null, null, null, null);
