...
| Coverage | 2,358+ tests across 305 test classes | — |
...
2,358+ tests across 305 test classes — all pass with no live AI or network calls.
...
├── application/src/test/    # 305 test classes (2,358+ tests)
