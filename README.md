...
| **Company Relationships** | Visual relationship mapping between companies showing partnerships, acquisitions, and competitive dynamics; force-directed graph with larger nodes (min 25px radius), sidebar-on-click detail panel, no hover tooltips |
